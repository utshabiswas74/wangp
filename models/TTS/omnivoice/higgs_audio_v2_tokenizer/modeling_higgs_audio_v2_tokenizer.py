...
def _conv1d_output_length(layer: nn.Conv1d, input_length):
...
class HiggsAudioV2TokenizerPreTrainedModel(PreTrainedAudioTokenizerBase):
    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, nn.Linear):
            ...
            module.inited.copy_(torch.tensor([True], device=module.inited.device))
    ...
    def _get_conv1d_output_lengths(self, input_length, module=None):
        ...
        for layer in conv1d_layers:
            input_length = _conv1d_output_length(layer, input_length)
...
class HiggsAudioV2TokenizerEuclideanCodebook(nn.Module):
    ...
    def quantize(self, hidden_states):
        embed = self.embed.to(hidden_states.device).t()
    ...
    def decode(self, embed_ind):
        embed = self.embed.to(embed_ind.device)
        quantized = F.embedding(embed_ind, embed)
        return quantized
