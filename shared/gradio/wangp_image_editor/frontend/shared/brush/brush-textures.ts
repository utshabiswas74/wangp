...
export class BrushTextures {
	...
	initialize_textures(): void {
		...
		this.app.renderer.render({
			...
			target: this.stroke_texture,
			clear: true
		});
		this.app.renderer.render({
			container: clear_container,
			target: this.erase_texture,
			clear: true
		});
	...
	commit_stroke(): void {
		...
		this.is_new_stroke = true;
		(this.app as any).wangp_request_render?.();
	}
	...
	draw_segment(
		...
		this.app.renderer.render({
			container: this.stroke_container,
			target: this.stroke_texture,
			clear: false
		});
