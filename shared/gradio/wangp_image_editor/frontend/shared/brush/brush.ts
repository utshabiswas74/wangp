...
export class BrushTool implements Tool {
	...
	private unsubscribe_scale: (() => void) | null = null;

	private wangp_request_render(): void {
	...
	async setup(
		...
		this.unsubscribe_scale?.();
		this.unsubscribe_scale = context.scale.subscribe((scale) => {
			this.scale = scale;
	...
	set_tool(tool: ToolbarTool, subtool: Subtool): void {
		...
		if (tool === "erase" || tool === "draw") {
			this.brush_textures?.reinitialize();
		}
